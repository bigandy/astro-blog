...
I often have the need to see the values of the CSS variables on the page. To be able to do this I need to use CSS `counter-reset` in combination with CSS `counter()` to display within CSS content on a before or after pseudo element. 
