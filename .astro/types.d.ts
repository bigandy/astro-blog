...
declare module 'astro:content' {
	...
	type ContentEntryMap = {
		"blog": {
"-drafts/friday-day-off/index.mdx": {
	id: "-drafts/friday-day-off/index.mdx";
  slug: "-drafts/friday-day-off";
  body: string;
  collection: "blog";
  data: InferEntrySchema<"blog">
} & { render(): Render[".mdx"] };
"-drafts/monday-zoe-tests.mdx": {
	id: "-drafts/monday-zoe-tests.mdx";
  slug: "-drafts/monday-zoe-tests";
  body: string;
  collection: "blog";
  data: InferEntrySchema<"blog">
} & { render(): Render[".mdx"] };
"-drafts/saturday-chilling/index.mdx": {
	id: "-drafts/saturday-chilling/index.mdx";
  slug: "-drafts/saturday-chilling";
  body: string;
  collection: "blog";
  data: InferEntrySchema<"blog">
} & { render(): Render[".mdx"] };
...
"big-three-cx-2023-24/index.mdx": {
	id: "big-three-cx-2023-24/index.mdx";
...
"weeknotes/2024/weeknotes-2024-12.md": {
	id: "weeknotes/2024/weeknotes-2024-12.md";
  slug: "weeknotes/2024/weeknotes-2024-12";
  body: string;
  collection: "blog";
  data: InferEntrySchema<"blog">
} & { render(): Render[".md"] };
